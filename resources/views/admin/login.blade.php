...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ asset('assets/niceadmin') }}/assets/img/favicon.png" rel="icon">
  <link href="{{ asset('assets/niceadmin') }}/assets/img/apple-touch-icon.png" rel="apple-touch-icon">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  <img src="{{ asset('assets/niceadmin') }}/assets/img/logo.png" alt="">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body p-5">
                  ...
                  <h5 class="card-title text-center pb-0 fs-4 mb-4">Login to Your Account</h5>
