                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input disabled type="text" name="lesson" value="{{ $teacher->lesson }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input disabled type="text" name="email" value="{{ $teacher->email }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input disabled type="text" name="phone" value="{{ $teacher->phone }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input disabled type="text" name="fb" value="{{ $teacher->fb }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input disabled type="text" name="tw" value="{{ $teacher->tw }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input disabled type="text" name="ig" value="{{ $teacher->ig }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea disabled name="bio" cols="10" rows="3"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input disabled type="file" name="image" value="{{ old('image') }}"
