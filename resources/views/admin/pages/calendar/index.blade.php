            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title d-flex justify-content-between align-items-center">
                        List Calendar
                        <a href="{{ url('admin/calendar/create') }}" class="btn btn-primary btn-sm">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            @php
                            $i = ($calendars->currentPage() - 1) * $calendars->count() + $key;
                            @endphp
                            <tr>
                                <th scope="row">{{ $i+1 }}</th>
                                <td>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('calendar.show', $item->id) }}" class="btn btn-sm btn-info">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <a href="{{ route('calendar.edit', $item->id) }}" class="btn btn-sm btn-primary">
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ route('calendar.destroy', $item->id) }}"
