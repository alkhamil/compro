                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <input disabled type="text" name="fullname" value="{{ $user->fullname }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input disabled type="text" name="nik" value="{{ $user->nik }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input disabled type="password" autocomplete="new-email" name="password"
                                    value="{{ old('password') }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select disabled class="form-select @error('role') is-invalid @enderror"
